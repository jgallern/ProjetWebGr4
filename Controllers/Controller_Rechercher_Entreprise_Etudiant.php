...
if (isset($_POST['submit-search'])) {
    ...
    // Perform the search
    $entreprises = $entrepriseModel->Rechercher_Entreprise_Etudiant($searchName, $searchSector, $searchVille);
    ...
    header('Location: ../views/view_etudiant/gestion_entreprise_etudiants.php');
    exit;
} else {
