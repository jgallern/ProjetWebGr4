...
<head>
    ...
    <meta name="description" content="Description de votre page pour les moteurs de recherche">
        ...
        <div id="profil">
            <div id="detail_profil" class="police_texte">
                <h3 id="nom_prenom_etudiant"><?php
                    ...
                    ?></h3>
                <a style="text-decoration: none;" href="../controllers/deconnection_controller.php"><button id="bouton_deconnexion" aria-label="Se déconnecter">Se déconnecter</button></a>
            </div>
    ...
    <main>
        ...
        <div class="bloc_gestion police_texte">
            ...
            <img width="150px" id="img_offre_page_presentation"
                src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.andrh.fr%2Fprestataires%2Fonlineformapro&psig=AOvVaw1QLVdktc6MNcY0vXlTb4j3&ust=1711034985290000&source=images&cd=vfe&opi=89978449&ved=0CBIQjRxqFwoTCIj-jZWUg4UDFQAAAAAdAAAAABAI" alt="Image de l'offre">
            ...
            <button aria-label="Candidater">Candidater</button>
        </div>
        ...
        <div class="bloc_gestion police_texte">
            <form>
                ...
                <input type="file" accept=".pdf" id="cv">
                <br>
                <label for="lettre_motivation">Ta lettre de motivation :</label><br>
