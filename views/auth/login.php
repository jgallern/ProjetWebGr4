...
<body>
    <div id="bienvenue">
        <a href="../page_accueil_ss_connexion.php"><img id="logo_connexion" alt="logo SEB"
    ...
    <form id="fenetre_login" class="police_texte" method="post" action="../../controllers/auth_controller.php">
        <h2>Qui es tu ?</h2>
        <input id="id_connection" name="id_connection" class="input_connexion" type="text"
            placeholder="Identifiant"><br><br>
        <h2>Ton mot de passe ? <span style="font-size: 0.7em;">(promis je garde ça secret)</span></h2>
        <input id="password_connection" name="password_connection" class="input_connexion" type="password"
